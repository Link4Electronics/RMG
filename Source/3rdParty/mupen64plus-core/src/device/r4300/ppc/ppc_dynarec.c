...
long FCR0, FCR31;
unsigned long last_addr = 0, interp_addr = 0;
unsigned int next_interupt = 0, CIC_Chip = 0;

/* Memory access globals */
unsigned long address = 0;
long long *rdword = NULL;
...
unsigned int dyna_mem(unsigned int value, unsigned int addr,
    ...
    unsigned long long int dyna_rdword;
    address = addr;
    ...
    case MEM_LWL:
        ...
        read_word_in_memory();
        switch(addr&3) {
        case 0: reg[value] = dyna_rdword; break;
        case 1: reg[value] = (reg[value]&0x00000000000000FFLL) | (dyna_rdword<<8); break;
        case 2: reg[value] = (reg[value]&0x000000000000FFFFLL) | (dyna_rdword<<16); break;
        case 3: reg[value] = (reg[value]&0x0000000000FFFFFFLL) | (dyna_rdword<<24); break;
        }
        sign_extended(reg[value]);
        break;
    case MEM_LWR:
        ...
        read_word_in_memory();
        switch(addr&3) {
        case 0: reg[value] = (reg[value]&0xFFFFFFFFFFFFFF00LL) | ((dyna_rdword>>24)&0xFF); break;
        case 1: reg[value] = (reg[value]&0xFFFFFFFFFFFF0000LL) | ((dyna_rdword>>16)&0xFFFF); break;
        case 2: reg[value] = (reg[value]&0xFFFFFFFFFF000000LL) | ((dyna_rdword>>8)&0xFFFFFF); break;
        case 3: reg[value] = dyna_rdword; break;
        }
        sign_extended(reg[value]);
        break;
    case MEM_SW:
