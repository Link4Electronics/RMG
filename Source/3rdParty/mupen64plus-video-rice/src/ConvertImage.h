...
// Convert N64 R8G8B8A8 format (0xRRGGBBAA) to COLOR_RGBA A8R8G8B8 format (0xAARRGGBB)
static inline uint32 N64ColorToCOLOR_RGBA(uint32 n64color)
{
    uint32 r = (n64color >> 24) & 0xFF;
    uint32 g = (n64color >> 16) & 0xFF;
    uint32 b = (n64color >> 8) & 0xFF;
    uint32 a = n64color & 0xFF;
